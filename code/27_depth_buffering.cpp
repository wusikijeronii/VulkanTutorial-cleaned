...
private:
  ...
  void createRenderPass() {
    ...
    // Input attachments
    // These will be written in the first subpass, transitioned to input
    // attachments and then read in the secod subpass
    ...
    */
    ...
    renderPassInfoCI.dependencyCount =
        static_cast<uint32_t>(dependencies.size());
    renderPassInfoCI.pDependencies = dependencies.data();

    if (vkCreateRenderPass(device, &renderPassInfoCI, nullptr, &renderPass) !=
        VK_SUCCESS) {
  ...
  void createDescriptorSetLayout() {
    ...
    std::array<VkDescriptorSetLayoutBinding, 3> bindings = {
        uboLayoutBinding, colorLayoutBinding, depthLayoutBinding};
  ...
  void createColorResources() {
    createImage(swapChainExtent.width, swapChainExtent.height,
                ...
                colorImageMemory);
    colorImageView = createImageView(colorImage, VK_FORMAT_R8G8B8A8_UNORM,
